...
export default function Presence(prop) {
        ...
        <div className="p-10">
          ...
          {studentInfo ? (
            <div className="space-y-6 text-lg">
              <div className="mb-8">
                <p className="mb-6 font-medium">Il est certifié que :</p>
                
                <div className="space-y-4 pl-6 border-l-2 border-gray-300">
                  <p>
                    <span className="font-semibold">Étudiant(e) :</span>{' '}
              ...
              <div className="mt-8 border-t-2 pt-6 border-gray-300">
                <p className="mb-4 text-justify">
                  A régulièrement fréquenté les cours et activités académiques 
                  de l'établissement pour l'année universitaire 2023-2024, 
                  conformément aux registres de présence officiels.
                </p>
                ...
                <div className="mt-10 flex justify-between items-end">
                  ...
                  <div className="text-right">
                    <p className="font-semibold mb-2">Le Responsable Pédagogique</p>
