      ...
      <div id="pdf-content" className="w-full max-w-3xl border border-gray-800 p-10 shadow-lg bg-white text-black">
        ...
        {studentInfo ? (
          <div className="text-lg leading-relaxed mt-6">
            ...
            <p className="mt-4 font-semibold">{studentInfo.name} {studentInfo.lastname}</p>
            <p>Né(e) en {studentInfo.birth} à {studentInfo.birth_place},</p>
            <p>Adresse e-mail : {studentInfo.email}</p>
            <p>Catégorie : {studentInfo.category}</p>
