...
export default function Quitness(prop) {
        ...
        <div className="p-10">
          ...
          {studentInfo ? (
            <div className="space-y-6 text-lg">
              <div className="mb-8">
                <p className="mb-6 font-medium">Reçu de :</p>
                ...
                <div className="space-y-4 pl-6 border-l-2 border-gray-300">
                  ...
                  <p>
                    ...
                    {prop.category}-2024-{Math.random().toString(36).substr(2, 6).toUpperCase()}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 border-t-2 pt-6 border-gray-300">
                <div className="mb-6 grid grid-cols-2 gap-4">
                  <p className="font-semibold">Montant : 250 TND</p>
                  <p className="font-semibold">Date : {new Date().toLocaleDateString('fr-FR')}</p>
                  <p className="col-span-2">Pour : Frais de scolarité annuels</p>
                </div>
                
                <div className="mt-10 flex justify-between items-end">
                  <div className="text-gray-700">
                    <p className="font-medium">Établi à Radès,</p>
                    <p>le {new Date().toLocaleDateString('fr-FR')}</p>
                  </div>
                  <div className="text-right">
                    <p className="font-semibold mb-2">Le Trésorier</p>
